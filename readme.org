...
- There is not enough data to draw any definitive conclusions on what
  ...
  - Can't decide between two favourites? Try strategy 6 (put your
    favourites first and second).
...
- [ ] More ways to "beat the algorithm"
- [ ] GPU optimisation of simulated annealing so we can run HETI's
  "millions of iterations" at home
- [ ] Implement all the other pathways (insert relevant Detroit:
  Become Human meme here)
* Sources
